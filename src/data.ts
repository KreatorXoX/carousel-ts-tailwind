export type SliderCardType = {
  title: string
  description: string
  footer: string
}

export const data: SliderCardType[] = [
  {
    title: 'First Card',
    description:
      'orem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ',
    footer: 'Footer'
  },
  {
    title: 'Second Card',
